...
render(){
  return (
    <div className="modal fade" id={`returnModal${this.props.bookId}`}
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          <div className="modal-header">
            ...
            id="exampleModalLabel">About to return this Book</h5>
            <button type="button"
...
export default connect(mapStateToProps, mapDispatchToProps)(ReturnBookModal);
